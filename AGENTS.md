...
This is an Expo SDK 57 / React Native 0.86 mobile app with a Supabase backend (Postgres, Auth, Realtime, Edge Functions). The package manager is **npm** (`package-lock.json`). Node.js 22 LTS is used.
