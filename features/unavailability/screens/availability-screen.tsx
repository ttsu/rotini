...
import { useClearUnavailability, useMyUnavailability } from '../hooks';
import { useAvailabilityConflicts } from '../use-availability-conflicts';
...
export function AvailabilityScreen() {
  ...
  const markedDates = useMemo(
    ...
    [windows, byWindowId, shifts, defaultTimeZone, todayIso],
  );
      ...
      >
        <View style={{ marginHorizontal: 16 }}>
          <AvailabilityCalendar
            ...
            onDayPress={() => {
              // Selection arrives with the add/edit sheet in the next unit.
            }}
            card={card}
